...
public class RecyclerAdapter1 extends RecyclerView.Adapter {
    ...
    public RecyclerAdapter1(List<POJO_Recycler_View> students, RecyclerView recyclerView) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof StudentViewHolder) {
            ...
            POJO_Recycler_View singleStudent = (POJO_Recycler_View) studentList.get(position);
    ...
    public static class StudentViewHolder extends RecyclerView.ViewHolder {
        ...
        public POJO_Recycler_View student;
