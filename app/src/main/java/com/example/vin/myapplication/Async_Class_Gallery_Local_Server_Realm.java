...
public class Async_Class_Gallery_Local_Server_Realm extends AsyncTask<Void, Void, Void> {
    ...
    public Async_Class_Gallery_Local_Server_Realm(fragment_User_Detail.FragmentCallback fragmentCallback, Context c, boolean loop_or_not, boolean Pdailog_show_or_not, boolean full_update) {
        try {
