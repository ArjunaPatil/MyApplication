 ...
 * Use the {@link fragment_upload_images_list#newInstance} factory method to
 * create an instance of this fragment.
 */
public class fragment_upload_images_list extends Fragment
    ...
    fragment_upload_images_list_adapter_for_selected_user adapterImages2;
    ...
    public fragment_upload_images_list() {
    ...
    public static fragment_upload_images_list newInstance(String param1, String param2) {
        fragment_upload_images_list fragment = new fragment_upload_images_list();
    ...
    private void show_dialog_for_select_employee() {
        try {
            if (SystemClock.elapsedRealtime() - mLastClickTime < 1500) {
                ...
                dialog.setTargetFragment(fragment_upload_images_list.this, 300);
    ...
    private void geturl() {
        try {
            ...
            if (code_emp.equals(emp_code)) {
                ...
                if (POJO2.size() > 0) {
                    adapterImages2 = new fragment_upload_images_list_adapter_for_selected_user(getContext(), POJO2);
