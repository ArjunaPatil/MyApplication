...
public class POJO_objective extends RealmObject {
    ...
    private String dcr_tbm;
    private String dcr_tbm_name;

    private String camp_tbm;
    private String camp_tbm_name;

    private String camp_patch;
    private String camp_patch_name;
    ...
    public String getDcr_tbm() {
        return dcr_tbm;
    }

    public void setDcr_tbm(String dcr_tbm) {
        this.dcr_tbm = dcr_tbm;
    }

    public String getDcr_tbm_name() {
        return dcr_tbm_name;
    }

    public void setDcr_tbm_name(String dcr_tbm_name) {
        this.dcr_tbm_name = dcr_tbm_name;
    }


    public String getCamp_tbm() {
        return camp_tbm;
    }

    public void setCamp_tbm(String camp_tbm) {
        this.camp_tbm = camp_tbm;
    }

    public String getCamp_tbm_name() {
        return camp_tbm_name;
    }

    public void setCamp_tbm_name(String camp_tbm_name) {
        this.camp_tbm_name = camp_tbm_name;
    }

    public String getCamp_patch() {
        return camp_patch;
    }

    public void setCamp_patch(String camp_patch) {
        this.camp_patch = camp_patch;
    }

    public String getCamp_patch_name() {
        return camp_patch_name;
    }

    public void setCamp_patch_name(String camp_patch_name) {
        this.camp_patch_name = camp_patch_name;
    }
