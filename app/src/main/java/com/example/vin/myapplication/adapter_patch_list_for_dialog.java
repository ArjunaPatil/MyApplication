...
public class adapter_patch_list_for_dialog extends ArrayAdapter<POJO_Patch_master> {
    public Context _context;
    public adapter_patch_list_for_dialog(Context context, int resource, List<POJO_Patch_master> POJO_Patch_master) {
